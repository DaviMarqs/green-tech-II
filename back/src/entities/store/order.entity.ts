...
import { NotaFiscal } from "./notafiscal.entity";
...
export class Pedido {
  ...
  @ManyToOne(() => Usuario, (usuario) => usuario.pedidos_comprados)
  @JoinColumn({ name: "id_usuario_comprador" })
  id_usuario_comprador: Usuario;

  @ManyToOne(() => Usuario, (usuario) => usuario.pedidos_vendidos)
  ...
  // Nota Fiscal
  @OneToOne(() => NotaFiscal, (nf) => nf.pedido)
  nota_fiscal: NotaFiscal;

  // Produtos do pedido
  @OneToMany(() => PedidoProduto, (pp) => pp.pedido)
